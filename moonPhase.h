...
#define DEG_TO_RAD_F32 0.0174532925f
...
private:
    float _fhour(const struct tm &timeinfo);
    moonData_t _getPhase(const int32_t year, const int32_t month, const int32_t day, const float &hour);
};
